        ...
        <form className="mt-6 flex flex-col sm:max-w-md" onSubmit={subscribe}>
            <div className='sm:flex sm:max-w-md'>
                ...
                <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                    <button
                        type="submit"
                        className="flex w-full items-center justify-center rounded-md bg-neon px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-black dark:hover:bg-gray-500 hover:text-neon focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neon"
                    >
                        Subscribirse
                    </button>
                </div>
            </div>
            <div className="text-gray-900 dark:text-gray-100 block mt-2 text-sm pl-2">{message}</div>
        </form>
    );
}