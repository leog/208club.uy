        ...
        <>
            ...
            <Layout preview={false}>
                <Container>
                    ...
                    <div className='flex mb-6 gap-4 items-start bg-gray-50 border border-gray-200 dark:bg-gray-900 dark:border-gray-500 p-4 rounded-br-3xl rounded-tl-3xl justify-center'>
                    ...
                    <h2 className="mb-8 text-4xl font-bold leading-tight tracking-tighter md:text-4xl">
                        Posts de {category.name.toLowerCase()}:
                    </h2>
